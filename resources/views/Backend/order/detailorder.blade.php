						...
						<div class="bootstrap-table">
							<div class="table-responsive">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="panel panel-blue">
												...
												<div class="panel-body">
													<strong><span class="glyphicon glyphicon-user" aria-hidden="true"></span> : {{ $orders->full }}</strong> <br>
													<strong><span class="glyphicon glyphicon-phone" aria-hidden="true"></span> : Số điện thoại: {{ $orders->phone }}</strong>
													<br>
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th>
												<h4 align='right' style="color: brown;">{{ number_format($orders->total,0,"",".") }}</h4>
											</th>
								...
								<div class="alert alert-primary" role="alert" align='right'>
									<a onclick="return processed()" name="" href="../../admin/order/paid/{{ $orders->id }}" class="btn btn-success" href="#" role="button">Đã xử lý</a>
								</div>
							</div>
						</div>
